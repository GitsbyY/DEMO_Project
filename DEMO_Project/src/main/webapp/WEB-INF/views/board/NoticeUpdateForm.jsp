...
<body>
   ...
   <div id='divContainer'>
      ...
      <form action='./updateCtr.do' method='post' enctype="multipart/form-data">      
         ...
         <input type="hidden" name="noticeNo" value="${noticeDto.NOTICE_NO}">
         <div id="tableDiv">
            <table>
               <tr id="firstTr">
                  ...
                  <td id="titleInputTd">
                     <input id="titleInput" type="text" 
                        name="noticeTitle" value="${noticeDto.NOTICE_TITLE}">
                  </td>      
               </tr>                           
               <tr id="secondTr">
               ...
               <tr id="thirdTr">
                  ...
                  <td id="contentInputTd">
                     <textarea id="contentInput" type="text" name="noticeContent">${noticeDto.NOTICE_CONTENT}</textarea>
                  </td>
               </tr>            
            </table>
         </div>
