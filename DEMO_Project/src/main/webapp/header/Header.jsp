		...
		<div id="headerSet" class="daengHeader">
			<div>
				<div id="daengLogo" class="logoSide"
					...
					<img alt="댕댕로고" src="./imgHeader/logo.png"
				...
				<div id="iconSet">
					<div class="buttonContainer">
						<div id="mallIcon" class="buttonSide">
							<img alt="쇼핑몰" src="./imgHeader/cart.jpg">
							<p>쇼핑몰</p>
						</div>
						<div id="mallBasket" class="buttonSide">
							<img alt="장바구니" src="./imgHeader/basket.jpg">
							<p>장바구니</p>
						</div>
						<div id="myDaeng" class="buttonSide">
							<img alt="마이댕댕" src="./imgHeader/customer.jpg">
							<p>마이댕댕</p>
						</div>
						<div id="customerCenter" class="buttonSide">
							<img alt="장바구니" src="./imgHeader/customcenter.jpg">
							<p>고객센터</p>
						</div>
					</div>
					<div id="bottomRow">
